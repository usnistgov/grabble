...
from typing import Generator  #1 (line in Coconut source)
from typing import NamedTuple  #1 (line in Coconut source)
from typing import Hashable  #1 (line in Coconut source)
from typing import Collection  #1 (line in Coconut source)
from functools import singledispatch  #TODO make generic parsing for Entity method, etc.  #2 (line in Coconut source)

ID: _coconut.typing.TypeAlias = 'Hashable | Generator[Hashable]'  #4 (line in Coconut source)

_coconut_typevar__E_0 = _coconut.typing.TypeVar("_coconut_typevar__E_0", bound="'Entity'")  #6 (line in Coconut source)
_coconut_typevar__C_0 = _coconut.typing.TypeVar("_coconut_typevar__C_0", bound='Collection')  #6 (line in Coconut source)

@singledispatch  #6 (line in Coconut source)
def make_entity(ent: Type[_coconut_typevar__E_0], props: _coconut_typevar__C_0) -> E_:  #7 (line in Coconut source)
    """useful for user-extension, parsing from custom objects"""  #8 (line in Coconut source)
    ...  #9 (line in Coconut source)




_coconut_typevar__P_0 = _coconut.typing.TypeVar("_coconut_typevar__P_0", bound='tuple')  #13 (line in Coconut source)
_coconut_typevar__ID_0 = _coconut.typing.TypeVar("_coconut_typevar__ID_0", bound='Hashable')  #13 (line in Coconut source)
class Entity(_coconut.typing.NamedTuple("Entity", [("label", '_coconut_typevar__ID_0'), ("props", '_coconut_typevar__P_0')]), _coconut.typing.Generic[_coconut_typevar__P_0, _coconut_typevar__ID_0]):  #13 (line in Coconut source)
    _coconut_is_data = True  #13 (line in Coconut source)
    __slots__ = ()  #13 (line in Coconut source)
    def __add__(self, other): return _coconut.NotImplemented  #13 (line in Coconut source)
    def __mul__(self, other): return _coconut.NotImplemented  #13 (line in Coconut source)
    def __rmul__(self, other): return _coconut.NotImplemented  #13 (line in Coconut source)
    __ne__ = _coconut.object.__ne__  #13 (line in Coconut source)
    def __eq__(self, other):  #13 (line in Coconut source)
        return self.__class__ is other.__class__ and _coconut.tuple.__eq__(self, other)  #13 (line in Coconut source)
    def __hash__(self):  #13 (line in Coconut source)
        return _coconut.tuple.__hash__(self) ^ hash(self.__class__)  #13 (line in Coconut source)
...
if __name__ == '__main__':  #41 (line in Coconut source)
    (print)(Entity(1, (1, 2, 3)))  #42 (line in Coconut source)
# Entity((1, 1,2,3))|>print

    class Fake(NamedTuple):  #45 (line in Coconut source)
        name: str  #46 (line in Coconut source)
        job: str  #47 (line in Coconut source)

    ent = Entity('ent1', Fake('rob', 'fixer'))  #49 (line in Coconut source)

    class FakeEntity(_coconut.typing.NamedTuple("FakeEntity", [("label", 'int'), ("props", 'Fake')]), Entity[int, Fake]):  #51 (line in Coconut source)
    ...
    (print)(FakeEntity(1, Fake('abc', 'blah')))  #53 (line in Coconut source)
    (print)(ent)  #54 (line in Coconut source)
